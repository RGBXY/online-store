<template>
  <div class="pt-32 px-10 mb-10 flex flex-col justify-between w-full h-full">
    <div class="h-[350px] text-white mb-10 flex justify-center items-center relative w-full">
    ...
    <div class="flex justify-between">
      <div class="w-[45%]">
        ...
        <p class="font-roboto text-lg mb-10">
          ...
          gaya dan layanan pelanggan yang ramah, Online Store hadir untuk memenuhi kebutuhan fashion Anda. Bergabunglah dengan kami dalam merayakan gaya hidup modern dan nikmati kemudahan berbelanja pakaian berkualitas tinggi dengan penuh
          kepercayaan.
        </p>
      ...
      <div class="w-[45%] flex gap-5 px-10">
        ...
        <img class="w-[250px] h-full object-cover" src="../../public/assets/image_about_2.jpeg" alt="" />
      </div>
    </div>
  </div>
</template>
